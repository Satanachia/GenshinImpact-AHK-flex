...
; Переключатель работает если "OldMacroBackVar > 0"
; 0 - Off
...
; Скрипт проверяет размер указателя мыши
FIXchat=0
...
; Отображать GUI при запуске - "1"
showmegui=1

; Защитные штуки: Ренеймер, ВинРенеймер, Хеш ченжер, Рандомизатор
ScRenamer=0
ScWinrenamer=0
ScHachCh=0
ScRandomT=0
